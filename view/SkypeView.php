   ...
   function CodeConversations ($Conversations)
   {
      ...
      foreach ($Conversations as $ConvNumber => $ConversationData) {
         ...
         $Code .= '               <div class="d-flex" id="'.$ConvNumber.'">'.
                  '                  <input class="form-check-input" type="checkbox" value="" id="flexCheck'.$Id.'" onclick="CheckOption (this);">'.
                  '                  <a class="nav-link '.$Class.' flex-fill" id="v-pills-'.$Id.'-tab" href="#v-pills-'.$Id.'" data-bs-toggle="pill" role="tab" onclick="ResetActiveNavLink (this)">'.
